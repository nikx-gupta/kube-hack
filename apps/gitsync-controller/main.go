...
func main() {
	log.Println("gitsync-controller started.")
	for {
		resp, err := http.Get("http://localhost:8001/apis/nikx.extensions.io/v1/gitsyncs?watch=true")
		if err != nil {
			panic(err)
		}
